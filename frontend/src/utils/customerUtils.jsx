...
const useCustomer = () => {
    const [customer, setCustomer] = useState(
        JSON.parse(localStorage.getItem('customer')) ? JSON.parse(localStorage.getItem('customer')) : null
    );
    ...
    return { customer, loading, error, searchCustomerByPhone, updatePointCustomer, createCustomer, setCustomer };
};
